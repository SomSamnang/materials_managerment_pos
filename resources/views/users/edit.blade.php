        ...
        <div class="col-lg-6 col-md-8">
            <div class="card shadow-lg border-0 rounded-4 hover-card">
                ...
                <div class="card-header bg-gradient-primary text-white text-center py-3 rounded-top-4">
                    <h4 class="mb-0">កែប្រែអ្នកប្រើប្រាស់</h4>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="ឈ្មោះ" value="{{ old('name', $user->name) }}">
                        ...
                        <!-- Email -->
                        <div class="form-floating mb-3">
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="អ៊ីមែល" value="{{ old('email', $user->email) }}">
                        ...
                        <!-- Password -->
                        <div class="form-floating mb-3">
                            <input type="password" name="password" class="form-control" id="password" placeholder="ពាក្យសម្ងាត់">
                            <label for="password">ពាក្យសម្ងាត់ (ប្តូរបើចង់)</label>
                        </div>
