...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 fw-bold"><i class="bi bi-pencil-square text-primary me-2"></i>{{ __('Edit Purchase') }}</h1>
            ...
            <form action="{{ route('purchases.update', $purchase) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="material_id" class="form-label">{{ __('Material') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                    <label for="purchase_date" class="form-label">{{ __('Date') }} <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                    <label for="unit_cost" class="form-label">{{ __('Unit Cost') }} ($) <span class="text-danger">*</span></label>
